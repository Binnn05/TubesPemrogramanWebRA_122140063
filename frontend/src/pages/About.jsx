  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 pt-20">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          Kami adalah tim pengembang yang berdedikasi untuk menciptakan platform digital yang user-friendly dan informatif. Proyek ini merupakan bagian dari tugas akhir mata kuliah Pemrograman Web, yang kami kerjakan dengan semangat untuk berkontribusi pada pengembangan pariwisata lokal.
        </p>
        <p className="text-gray-700 leading-relaxed">
        ...
        <div className="mt-6 text-center text-gray-600">
          <p className="font-medium">Pengembang:</p>
          <ul className="list-disc list-inside mx-auto max-w-sm mt-2">
            <li>Abyan King Al Baihaqy (122140063)</li>
          </ul>
        </div>
      </div>
    </div>
